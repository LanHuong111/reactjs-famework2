    ...
    <>
      <div className="bg-[rgb(228,228,228)] p-5 rounded-[5px]">
        <div className="py-3">
          ...
          <span className="text-[20px] block text-center font-bold">Đặt hạn mức chi tiêu</span>
          <span className="text-[16px] text-center block">Bạn sẽ được thông báo khi chi tiêu danh mục đạt tới giới hạn</span>
