        ...
        <>
            {user ? (
                <>
                    ...
                    <div onClick={() => setShowFormSpending(true)} className="flex justify-center mt-4 items-center gap-2 cursor-pointer border-2 border-blue-500 p-2 rounded-[5px]">
                        <span className="text-blue-500 font-semibold">Tạo Giao Dịch Chi Tiêu</span>
                    </div>
                </>
            ) : (
